...
// ✅ CAMBIO 1: Agregar las nuevas props
...
export function PropertyCard({
  ...
  // ✅ CAMBIO 2: Calcular estado del botón de comparación
  const isInCompare = compareList.some((p) => p.id === property.id);
  const isDisabled = !isInCompare && compareList.length >= 3;
